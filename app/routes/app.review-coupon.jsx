...
function CouponPreview({ enabled, code, message }) {
  if (!enabled || !code) {
    return (
      ...
      }} className="tr-app-routes-app-review-coupon-div-1">
  ...
  return (
    ...
    }} className="tr-app-routes-app-review-coupon-div-2">
      <div style={{ fontSize: 13, color: SHELL_C.text, marginBottom: 16, lineHeight: 1.6 }} className="tr-app-routes-app-review-coupon-div-3">{message}</div>
      <div style={{
        display: "inline-flex", alignItems: "center", gap: 10,
        border: `1.5px dashed ${SHELL_C.accent}`, borderRadius: 9, padding: "10px 16px",
        background: SHELL_C.accentLt,
      }} className="tr-app-routes-app-review-coupon-div-4">
        <span style={{ fontFamily: "monospace", fontSize: 15, fontWeight: 600, color: SHELL_C.text, letterSpacing: ".04em" }} className="tr-app-routes-app-review-coupon-span-5">{code}</span>
        <span style={{
          fontSize: 11.5, fontWeight: 600, color: "#fff", background: SHELL_C.accent,
          borderRadius: 6, padding: "5px 11px",
        }} className="tr-app-routes-app-review-coupon-span-6">Copy</span>
      </div>
    </div>
  );
}
...
export default function ReviewCouponSettings() {
  ...
  if (!initial.isPro) {
    return (
      <div style={{ minHeight: "100vh", background: SHELL_C.bg, fontFamily: "var(--app-font-family)" }} className="tr-app-routes-app-review-coupon-div-7">
        <AdvancedPaywall
  ...
  return (
    <div style={{ minHeight: "100vh", background: SHELL_C.bg, fontFamily: "var(--app-font-family)" }} className="tr-app-routes-app-review-coupon-div-8">
      {/* ── Topbar ── */}
      <div style={{
      ...
      }} className="tr-app-routes-app-review-coupon-div-9">
        <div style={{ display: "flex", alignItems: "center", gap: 10 }} className="tr-app-routes-app-review-coupon-div-10">
          <Link to="/app" style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 6 }} className="tr-app-routes-app-review-coupon-div-11">
            <Link to="/app" style={{ fontSize: 13, color: SHELL_C.muted, textDecoration: "none" }}>Home</Link>
            <span style={{ fontSize: 13, color: SHELL_C.muted }} className="tr-app-routes-app-review-coupon-span-12">/</span>
            <span style={{ fontSize: 13, fontWeight: 600, color: SHELL_C.text }} className="tr-app-routes-app-review-coupon-span-13">Review Coupon</span>
          </div>
        </div>

        <div style={{ display: "flex", alignItems: "center", gap: 12 }} className="tr-app-routes-app-review-coupon-div-14">
          {saved && (
            <span style={{
              display: "inline-flex", alignItems: "center", gap: 5,
              fontSize: 12, fontWeight: 600, color: SHELL_C.green,
              background: SHELL_C.greenLt, padding: "4px 12px", borderRadius: 20,
            }} className="tr-app-routes-app-review-coupon-span-15">
              Saved
            </span>
          )}
          <button
           ...
           className="tr-app-routes-app-review-coupon-button-16">
            Save
          </button>
        </div>
      </div>
      ...
      {/* ── Content ── */}
      <div style={{ maxWidth: 640, margin: "0 auto", padding: "28px 24px" }} className="tr-app-routes-app-review-coupon-div-17">
        <div style={{ marginBottom: 24 }} className="tr-app-routes-app-review-coupon-div-18">
          <h2 style={{ fontSize: 20, fontWeight: 600, color: SHELL_C.text, margin: "0 0 6px" }} className="tr-app-routes-app-review-coupon-h2-19">Review Coupon</h2>
          <p style={{ fontSize: 13, color: SHELL_C.muted, margin: 0, lineHeight: 1.6 }} className="tr-app-routes-app-review-coupon-p-20">
        ...
        <div style={{
        ...
        }} className="tr-app-routes-app-review-coupon-div-21">
          <ToggleField
          ...
          <Field label="Message shown with the code" helpText="Keep it short — it's shown right above the code.">
            <textarea
             ...
             className="tr-app-routes-app-review-coupon-textarea-22"/>
          </Field>
        </div>

        <div style={{ fontSize: 11.5, fontWeight: 600, color: SHELL_C.muted, textTransform: "uppercase", letterSpacing: ".06em", marginBottom: 10 }} className="tr-app-routes-app-review-coupon-div-23">
