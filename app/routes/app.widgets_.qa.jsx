...
function QaPreview({ settings }) {
  const s = settings;
  return (
    <div style={{ fontFamily: s.fontFamily === "inherit" ? undefined : s.fontFamily }} className="tr-app-routes-app-widgets-qa-div-1">
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 18 }} className="tr-app-routes-app-widgets-qa-div-2">
        <h3 style={{ fontSize: 18, fontWeight: 600, margin: 0, color: s.textColor }} className="tr-app-routes-app-widgets-qa-h3-3">Questions & Answers</h3>
        <button style={{ background: s.accentColor, color: "#fff", border: "none", borderRadius: 6, padding: "9px 18px", fontSize: 13, fontWeight: 600, cursor: "default" }} className="tr-app-routes-app-widgets-qa-button-4">
          Ask a question
        </button>
      </div>
      <div style={{ paddingTop: 14, borderTop: "1px solid #eee" }} className="tr-app-routes-app-widgets-qa-div-5">
        <p style={{ fontSize: 14, fontWeight: 600, color: s.textColor, margin: "0 0 6px" }} className="tr-app-routes-app-widgets-qa-p-6">
          <span style={{ color: "#888" }} className="tr-app-routes-app-widgets-qa-span-7">Q: </span>Is this moisturizer suitable for sensitive skin?
        </p>
        <p style={{ fontSize: 13, color: s.textColor, margin: "0 0 6px", lineHeight: 1.5 }} className="tr-app-routes-app-widgets-qa-p-8">
          <span style={{ color: s.accentColor, fontWeight: 600 }} className="tr-app-routes-app-widgets-qa-span-9">A: </span>Yes, it's dermatologically tested and safe for sensitive skin.
        </p>
        <div style={{ fontSize: 11, color: "#999" }} className="tr-app-routes-app-widgets-qa-div-10">Darlene Robertson · Jun 2, 2026</div>
      </div>
    </div>
  );
}
    ...
    <WidgetCustomizeShell
      ...
      installSection={
        <InstallSection
          ...
          note={
            <span className="tr-app-routes-app-widgets-qa-span-11">
