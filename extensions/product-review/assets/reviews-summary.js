(function(){
  ...
  window.rsPreviewFile = function(event){
    ...
    if(file.type.startsWith("image/")) preview.innerHTML = '<img class="tr-extensions-product-review-assets-reviews-summary-img-1" src="' + url + '">';
    else if(file.type.startsWith("video/")) preview.innerHTML = '<video class="tr-extensions-product-review-assets-reviews-summary-video-2" src="' + url + '" controls></video>';
  };
  ...
  function renderBreakdown(reviews, total){
    ...
    [5, 4, 3, 2, 1].forEach(function(n){
      ...
      html += '<div class="rs-breakdown-row">' +
        '<span class="tr-extensions-product-review-assets-reviews-summary-span-3">' + n + '★</span>' +
  ...
  function buildCardHTML(r){
    ...
    if(r.mediaUrl){
      ...
      mediaHTML = r.mediaType && r.mediaType.startsWith("video/")
        ? '<div class="rs-card-media"><video class="tr-extensions-product-review-assets-reviews-summary-video-4" src="' + escapeHTML(src) + '" controls></video></div>'
        : '<div class="rs-card-media"><img class="tr-extensions-product-review-assets-reviews-summary-img-5" src="' + escapeHTML(src) + '" alt="Review media"></div>';
    }
    return (
