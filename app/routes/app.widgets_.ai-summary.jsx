...
function SummaryPreview({ accentColor, textColor, fontFamily }) {
  return (
    ...
    }} className="tr-app-routes-app-widgets-ai-summary-div-1">
      <span style={{ fontSize: 11, fontWeight: 600, letterSpacing: ".03em", textTransform: "uppercase", color: accentColor }} className="tr-app-routes-app-widgets-ai-summary-span-2">AI Summary</span>
      <p style={{ margin: "8px 0 0", fontSize: 14, lineHeight: 1.6, color: textColor }} className="tr-app-routes-app-widgets-ai-summary-p-3">
...
function ProductRow({ product, aiConfigured }) {
  ...
  return (
    <div style={{ display: "flex", gap: 14, padding: "14px 0", borderTop: `1px solid ${SHELL_C.border}` }} className="tr-app-routes-app-widgets-ai-summary-div-4">
      <img
       ...
       className="tr-app-routes-app-widgets-ai-summary-img-5"/>
      <div style={{ flex: 1 }} className="tr-app-routes-app-widgets-ai-summary-div-6">
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 10 }} className="tr-app-routes-app-widgets-ai-summary-div-7">
          <div className="tr-app-routes-app-widgets-ai-summary-div-8">
            <div style={{ fontWeight: 600, fontSize: 13.5 }} className="tr-app-routes-app-widgets-ai-summary-div-9">{product.title}</div>
            <div style={{ fontSize: 11.5, color: SHELL_C.muted }} className="tr-app-routes-app-widgets-ai-summary-div-10">{product.reviewCount} approved reviews</div>
          </div>
          <button
            onClick={generate}
           ...
           className="tr-app-routes-app-widgets-ai-summary-button-11">
            {loading ? "Generating…" : summary ? "Regenerate" : "Generate"}
          </button>
        </div>
        {summary && <p style={{ fontSize: 12.5, color: SHELL_C.text, marginTop: 8, lineHeight: 1.5 }} className="tr-app-routes-app-widgets-ai-summary-p-12">{summary}</p>}
        {error && <p style={{ fontSize: 11.5, color: "#a5423b", marginTop: 6 }} className="tr-app-routes-app-widgets-ai-summary-p-13">{error}</p>}
      </div>
    </div>
  );
}
    ...
    <WidgetCustomizeShell
      ...
      installSection={
        <InstallSection
          ...
          note={!aiConfigured ? (
            <span className="tr-app-routes-app-widgets-ai-summary-span-14">Add <code className="tr-app-routes-app-widgets-ai-summary-code-15">ANTHROPIC_API_KEY</code> to your <code className="tr-app-routes-app-widgets-ai-summary-code-16">.env</code> to enable AI summary generation.</span>
          ) : null}
        />
      }
      sections={[
      ...
      preview={
        <div className="tr-app-routes-app-widgets-ai-summary-div-17">
          <SummaryPreview accentColor={accentColor} textColor={textColor} fontFamily={fontFamily} />
          <div style={{ marginTop: 26 }} className="tr-app-routes-app-widgets-ai-summary-div-18">
            <div style={{ fontSize: 11, fontWeight: 600, color: SHELL_C.muted, textTransform: "uppercase", letterSpacing: ".05em", marginBottom: 6 }} className="tr-app-routes-app-widgets-ai-summary-div-19">
              Products to summarize
            </div>
            {products.length === 0 ? (
              <div style={{ padding: "40px 0", textAlign: "center", color: SHELL_C.muted, fontSize: 13 }} className="tr-app-routes-app-widgets-ai-summary-div-20">
