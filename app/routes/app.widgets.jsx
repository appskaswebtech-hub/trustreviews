...
const WIDGETS = [
  ...
  },
  {
    key: "insta_stories",
    title: "Insta Stories",
    description: "Instagram-style photo & video reviews, two ways: a Stories tray (tap a circle for a fullscreen player) or a Reels feed (continuous vertical scroll). Switch modes in Widget Design.",
