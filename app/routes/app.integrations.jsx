...
function ProviderCard({ providerKey, provider, connected }) {
  ...
  return (
    <div
     ...
     className="tr-app-routes-app-integrations-div-1">
      <div style={{
        height: 100, background: provider.bg, display: "flex",
        alignItems: "center", justifyContent: "center", fontSize: 32, position: "relative",
      }} className="tr-app-routes-app-integrations-div-2">
        <span style={{
          width: 44, height: 44, borderRadius: "50%",
          background: "rgba(255,255,255,.55)", color: C.text,
          display: "flex", alignItems: "center", justifyContent: "center",
          fontSize: 18, fontWeight: 600,
        }} className="tr-app-routes-app-integrations-span-3">{provider.label.charAt(0).toUpperCase()}</span>
        {connected && (
          <span style={{
          ...
          }} className="tr-app-routes-app-integrations-span-4">✓ Connected</span>
        )}
      </div>
      <div style={{ padding: "16px 18px", flex: 1, display: "flex", flexDirection: "column", gap: 8 }} className="tr-app-routes-app-integrations-div-5">
        <div style={{ fontSize: 15, fontWeight: 600, color: C.text }} className="tr-app-routes-app-integrations-div-6">{provider.label}</div>
        <div style={{ fontSize: 12.5, color: C.muted, lineHeight: 1.5, flex: 1 }} className="tr-app-routes-app-integrations-div-7">{provider.description}</div>
        <Link
...
export default function IntegrationsGalleryPage() {
  ...
  if (!isPro) {
    return (
      <div style={{ fontFamily: "var(--app-font-family)", background: C.bg, minHeight: "100vh", padding: 28 }} className="tr-app-routes-app-integrations-div-8">
        <AdvancedPaywall
  ...
  return (
    <div style={{ fontFamily: "var(--app-font-family)", background: C.bg, minHeight: "100vh", padding: 28 }} className="tr-app-routes-app-integrations-div-9">
      <h1 style={{ fontSize: 24, fontWeight: 600, color: C.text, margin: "0 0 4px" }} className="tr-app-routes-app-integrations-h1-10">Integrations</h1>
      <p style={{ fontSize: 13, color: C.muted, margin: "0 0 20px" }} className="tr-app-routes-app-integrations-p-11">
      ...
      <div style={{
        ...
        gap: 16,
      }} className="tr-app-routes-app-integrations-div-12">
