      ...
      {open && (
        <>
          ...
          <div style={{ display: "flex", justifyContent: "flex-end", gap: 10 }}>
            <button onClick={() => setOpen(false)} style={{ padding: "10px 20px", background: "#fff", color: "#555", border: "1.5px solid #ddd", borderRadius: s.borderRadius, fontSize: 14, cursor: "pointer" }}>
              Cancel
            </button>
